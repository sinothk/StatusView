package com.sinothk.view.statusDemo;//package com.sinothk.android.views.statusLayout.demo;
...
import com.sinothk.view.status.OnRetryListener;
import com.sinothk.view.status.OnShowHideViewListener;
import com.sinothk.view.status.StatusLayoutManager;
...
//                        Toast.makeText(OneStepActivity.this, "onShowView", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onHideView(View view, int id) {
//                        Toast.makeText(OneStepActivity.this, "onHideView", Toast.LENGTH_SHORT).show();
                    }
                })
                .onRetryListener(new OnRetryListener() {
                    @Override
                    public void onRetry() {
                        Toast.makeText(OneStepActivity.this, "onRetry", Toast.LENGTH_SHORT).show();
                    }
                })
                .build();
    }
